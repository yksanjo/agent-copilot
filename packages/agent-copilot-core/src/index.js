/**
 * agent-copilot-core - Package 1: core for AI Copilot for Developers
 * Project: agent-copilot
 */
export class AgentCopilotCore {
  constructor(options = {}) {
    this.name = 'agent-copilot-core';
...
export default AgentCopilotCore;
