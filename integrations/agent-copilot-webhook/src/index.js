/**
 * agent-copilot-webhook - Integration: webhook for AI Copilot for Developers
 * Project: agent-copilot
 */
export class AgentCopilotWebhook {
  constructor(options = {}) {
    this.name = 'agent-copilot-webhook';
...
export default AgentCopilotWebhook;
